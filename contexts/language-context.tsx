...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  const [supportedLanguages, setSupportedLanguages] = useState<
    Array<{ code: string; name: string; name_local?: string }>
  >([]);
  ...
  const translate = useCallback(
    async (text: string, targetLang?: string): Promise<string> => {
      console.log("LanguageContext: translate called", {
        text,
        targetLang,
      ...
      console.log("LanguageContext: Target language", {
        target,
        originalTarget: targetLang,
      });

      // Don't translate if target is English
      if (target === "en") {
        console.log(
          "LanguageContext: Target is English, no translation needed"
        );
        return text;
      }
      ...
      try {
        ...
        console.log("LanguageContext: Translation successful", {
          original: text,
  ...
  const translateBatch = useCallback(
    async (texts: string[], targetLang?: string): Promise<string[]> => {
      ...
      try {
        const results = await libreTranslateService.translateBatch(
          texts,
          target,
          "auto"
        );
  ...
  const translations: Record<string, Record<string, string>> = {
    en: {
      ...
      "dashboard.analytics.description":
        "View real-time metrics, trends, and performance.",
      ...
      "dashboard.investor.description":
        "Discover deals and track portfolio activity.",
      "dashboard.mentor": "Mentor Hub",
      "dashboard.mentor.description":
        "Support startups and manage mentorship sessions.",
      "dashboard.teacher": "Educator Hub",
      "dashboard.teacher.description":
        "Courses, classes, and student engagement.",
      "dashboard.growthstarter": "Growthstarter",
      "dashboard.growthstarter.description":
        "Launch and manage crowdfunding campaigns.",
      "dashboard.startup": "Startup HQ",
      "dashboard.startup.description":
        "Operate your startup and track progress.",
      "dashboard.super-admin": "Super Admin",
      "dashboard.super-admin.description":
    ...
    es: {
      ...
      "sports.subtitle":
        "Conecta con otros fundadores a través del deporte, torneos y actividades de networking",
      "action.create": "Crear",
      "action.edit": "Editar",
    ...
    fr: {
      ...
      "sports.subtitle":
        "Connectez-vous avec d'autres fondateurs par le sport, les tournois et les activités de réseautage",
      "action.create": "Créer",
    ...
    de: {
      ...
      "sports.subtitle":
        "Verbinden Sie sich mit anderen Gründern durch Sport, Turniere und Networking-Aktivitäten",
  ...
  const phraseTable: Record<string, Partial<Record<string, string>>> = {
    ...
    "try app": {
      zh: "试用应用",
      es: "Probar aplicación",
      fr: "Essayer l'application",
      de: "App testen",
    },
    "apply now": {
      zh: "立即申请",
    ...
    "submit app": {
      zh: "提交应用",
      es: "Enviar aplicación",
      fr: "Soumettre l'application",
      de: "App einreichen",
    },
    "submit deal": {
      zh: "提交优惠",
      es: "Enviar oferta",
      fr: "Soumettre l'offre",
      de: "Angebot einreichen",
    },
    "view teams": {
      zh: "查看队伍",
      es: "Ver equipos",

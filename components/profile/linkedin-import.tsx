...
export default function LinkedInImport() {
  ...
  const handleImport = async (profileType: string) => {
    if (!user?.accessToken) {
      setError(
        "No LinkedIn access token available. Please login with LinkedIn first."
      );
      return;
    }
    ...
    try {
      ...
      setError(
        `Failed to import ${profileType} profile: ${
          ...
          <>
            ...
            <div className="text-center py-4">
              ...
              <p className="text-sm text-gray-600 mb-4">
                Your LinkedIn profile has been successfully imported to
                GrowthLab
              </p>

  ...
  const handleSave = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your job settings have been updated successfully."
      })
    } catch (error) {
      toast({
        title: "Error",
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Configure your job posting preferences</p>
              </div>
            </div>
            <Button onClick={handleSave} disabled={isSaving} className="bg-[#0F7377] hover:bg-[#0F7377]/90">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Get notified about job performance metrics</p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Get daily updates on job performance</p>
                    </div>
                    <Switch
              ...
              <CardContent>
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Receive immediate notifications for important events</p>
                  </div>
                  <Switch
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Select 
                      ...
                      onValueChange={(value) => handleSettingChange("defaultApplicationMethod", value)}
                    >
                      <SelectTrigger>
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="platform">GrowthLab Platform</SelectItem>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Automatically approve applications that meet basic criteria</p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Candidates must submit a cover letter</p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Candidates must upload a resume</p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Allow candidates to apply through external links</p>
                    </div>
                    <Switch
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Display your company name in job postings</p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Display contact details in job postings</p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Let candidates apply without creating an account</p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Candidates must be logged in to apply</p>
                    </div>
                    <Switch
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Use custom email templates for notifications</p>
                    </div>
                    <Switch
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Automatically post jobs to LinkedIn</p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Automatically post jobs to Glassdoor</p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Optimize jobs for Google search results</p>
                    </div>
                    <Switch
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Automatically close jobs after a certain period</p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Track job performance and candidate metrics</p>
                    </div>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Use AI-powered features for job optimization</p>
                    </div>
                    <Switch

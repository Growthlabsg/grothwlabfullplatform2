...
export default function ProfileSettingsPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 relative">
      <ComingSoonOverlay
        title="Coming Soon"
        description="Profile settings are being upgraded with exciting new features. Stay tuned!"
      />
      {/* Header Navigation */}
              ...
              <CardContent className="space-y-3">
                <div className="text-sm space-y-2">
                  <div className="flex items-start gap-2">
                    ...
                    <span>
                      Add a professional headshot to increase profile views by
                      40%
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="w-2 h-2 rounded-full bg-blue-500 mt-2 flex-shrink-0" />
                    <span>
                      Complete your bio to help others understand your expertise
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="w-2 h-2 rounded-full bg-blue-500 mt-2 flex-shrink-0" />
                    <span>
                      Add skills to showcase your professional capabilities
                    </span>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="w-2 h-2 rounded-full bg-blue-500 mt-2 flex-shrink-0" />
                    <span>
                      Share your digital name card to expand your network
                    </span>
                  </div>
                </div>
              </CardContent>
